...
public class BoardDAOImpl implements BoardDAO {
	 ...
	 * DataAccessException { // 현재 게시글의 갯수를 나타냄 int articleNO =
	 * selectNewArticleNO(); // 새 게시글의 번호를, 게시글 작성하는 요소로 추가.
	 * articleMap.put("articleNO", articleNO); // articleMap : 게시글의 요소를 다 담아서. 실제
	 * 디비에 반영하는 로직. sqlSession.insert("mapper.board.insertNewArticle",articleMap);
	 * return articleNO; }
	 */
